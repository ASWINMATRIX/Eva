...
const array = ['account poyi','Don','Eee','5','Good Morning','Hm','offer','poda myre','powli','romantic','sed','song','spam','Ha','Eda','ElsaMwol','Friend','group','Happy','help','Hi','Hlo','jihad','Kali','Kalikkuno','Kundan','Myra','Nanba','nanban','Ntha','Ok','para','photo','poda','really','song','sticker','tha','Thund','Va','Vazhe','video','You']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
