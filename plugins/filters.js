...
const array = ['Elsa','Hi','rip','Di','Sed','Friend','Kannappi','Group','Single','Alamb','owner','Jihad','Nanban','mone','Song','Pm','Bgm','Nidhin','Moodesh','Thyr','Ok bie','Enthada','help','Adi','Anthas','Boss','Pubg','Free Fire','Kali','Kaztro','mention','Da','Name','Shahul','bot','song','hlo','Hlo','power','love','Lub','message','myre','mess','power','love','Lub','message','myre','Alla','mess','menu','Ara','ara','Ayin','movie','mathi','Good night','okku','Ombi','over','Phaa','Podi','setta','vazha','vedi','Vijay','Ah','ano','Arumille','Dance','dey','Etha','Good morning','good night','group','Hy','Ivan','Kando','kannappi','life','Mandan','one','vazha','vanno','Vala','thanks','Super','Song2','Song1','sheri','Reels','rasam','Psycho','Pwr','Poyi','pottan','Poli','pokko','poda','Pattumo']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
